...
## Mocking Private or Protected Functions ##
...
## Returning References from Mock Functions ##
...
## Returning Live Values from Mock Functions ##
...
from Mock Functions"). However, Google Mock doesn't let you use
...
## Setting the Default Actions for a Mock FunctionBase ##
...
## Using Functions/Functions/Functors as Actions ##
...
## Invoking a FunctionBase/FunctionBase/Functor Without Arguments ##
...
## Invoking an Argument of the Mock FunctionBase ##
...
## Mocking Functions That Use Move-Only Types ##
...
A `Buzz` object represents a snippet being posted.  A class that implements the `Buzzer` interface is capable of creating and sharing `Buzz`.  Functions in `Buzzer` may return a `unique_ptr<Buzz>` or take a `unique_ptr<Buzz>`.  Now we need to mock `Buzzer` in our tests.
...
foo_test.cc:14: Mock function call matches EXPECT_CALL(mock, F(_, _))...
    FunctionBase call: F(@0x7fff7c8dad40"a", @0x7fff7c8dad10"good")
foo_test.cc:15: Mock function call matches EXPECT_CALL(mock, F("a", "b"))...
    FunctionBase call: F(@0x7fff7c8dada0"a", @0x7fff7c8dad70"b")
